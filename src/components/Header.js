    ...
    <div>
      <div className="navbar bg-white lg:h-[88px] shadow-lg ">
        <div className="dropdown navbar-start lg:hidden">
          ...
          >
            <li className="my-5">
              <div className=" border-[1.4px] lg:w-[360px] h-[48px] rounded flex  items-center border-[#515151]">
                <FontAwesomeIcon
        ...
        <div className="navbar-center lg:navbar-start">
          <img
            className="lg:ml-[99px]  lg:w-[96px] lg:h-[48px] h-16 w-16 object-contain"
            alt=""
            src={Logo}
          />
          <div className="lg:ml-[117px]  ml-12 border-[1.4px] lg:w-[360px] h-[48px] rounded lg:flex hidden  items-center border-[#515151]">
            <FontAwesomeIcon
              className="text-[14.25px] ml-[18px] mr-[11.75px] text-[#515151]"
              icon={faMagnifyingGlass}
            />
